...
\begin{frame}{Subjektive Evaluation}
	...
	\smallskip
	~~~\emph{Kategorische Ablehnung} (neg. bias) gegenüber KI-Musik\todo[inline]{Ansani et al. 2025; White et al. 2025; Shank et. al. 2023}%\\
	\smallskip
...
\begin{frame}{Variational Auto-Encoder}{(VAE)}
	\missingfigure{Show Neural network with bottleneck}
	\includegraphics[width=0.49\textwidth]{img/MLP-Theorie.png}
\end{frame}
...
\begin{frame}{Generative Adversarial Network}{(GAN)}
	...
	\vfill
	\hfill\scriptsize Bildquelle: \url{https://ijpds.org/article/view/2158}
\end{frame}
...
\begin{frame}
	\todo[inline]{Suno \& Udio \conclude GEMA gewinnt Urheberrechtsstreit}
	\missingfigure{Zeitungsartikel}
\end{frame}
