...
\title{\vspace{-2cm}\newline\includegraphics[height=0.08\textheight]{logos/TU_Dortmund.jpg}\hspace{0.46\textwidth}\includegraphics[height=0.08\textheight]{logos/fi_logo_german.png}\vspace{0.5cm}\newline\thetitle}
\author{\theauthor}
